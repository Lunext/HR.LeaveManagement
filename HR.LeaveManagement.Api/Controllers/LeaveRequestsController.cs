...
namespace HR.LeaveManagement.Api.Controllers
{
    ...
    public class LeaveRequestsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<LeaveRequestListDto>>> Get(bool isLogged= false)
        {
        ...
        {
            var leaveRequest = await mediator.Send(new GetLeaveRequestDetailQuery(id));
        ...
        public async Task<IActionResult> Post(CreateLeaveRequestCommand leaveRequest)
        {
